class WorkController < ApplicationController
  def index
    ...
    @selected_theme = (".def_select_theme")
    @selected_image_name = 'travel'
  ...
  def display_theme
    ...
    if params[:theme] == "-----" #.blank?
      ...
      data = { index: 0, name: 'travel', values_qty: values_qty,
               file: 'defoult.jpg', image_id: 4,
